...
const { nonExistingRoutesErrorHandler } = await import("../non-existing-route.error-handler.js");
describe("nonExistingRoutesErrorHandler", () => {
    it("forwards a NotFoundError with the correct properties to next()", () => {
        const next = jest.fn();
        nonExistingRoutesErrorHandler({}, {}, next);
        ...
        expect(errorArg.message).toBe("Not Found: The route you requested does not exist.");
    });
});
//# sourceMappingURL=non-existing-routes.error-handler.unit.test.js.map