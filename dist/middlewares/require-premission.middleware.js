...
export function requirePermission(resource, action) {
    return async (req, res, next) => {
        try {
            ...
            const allowed = permissionSet.has(permissionKey) ||
                Array.from(permissionSet).some((k) => k.endsWith(".*") && permissionKey.startsWith(k.slice(0, -2)));
            if (!allowed) {
...
//# sourceMappingURL=require-premission.middleware.js.map