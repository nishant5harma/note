...
const MAX_FILE_SIZE = parseInt(process.env.MAX_IMAGE_SIZE_BYTES ?? String(5 * 1024 * 1024), 10); // default 5MB
            ...
            supabaseMemoryMulti.array(fieldName, maxCount)(req, res, async (err) => {
                ...
                try {
                    ...
                    for (const f of files) {
                        const { url, storageKey } = await uploadBufferToSupabase(f.buffer, f.originalname, f.mimetype);
