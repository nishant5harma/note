...
AttendanceRouter.post("/checkin", requireAuth, requirePermission("attendance", "self"), AttendanceController.attendanceCheckinHandler);
// Checkout: authenticated + permission to perform own attendance
AttendanceRouter.post("/checkout", requireAuth, requirePermission("attendance", "self"), AttendanceController.attendanceCheckoutHandler);
// List (admin/manager): requires read permission
AttendanceRouter.get("/", requireAuth, requirePermission("attendance", "read"), AttendanceController.attendanceListHandler);
