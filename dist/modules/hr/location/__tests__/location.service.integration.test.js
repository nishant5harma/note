...
describe("LocationService (integration)", () => {
    ...
    it("rejects non-target responder", async () => {
        ...
        await expect(LocationService.respondToLocationRequest(r, lr.id, {
            latitude: 1,
            longitude: 1,
    ...
    it("rejects expired request and marks EXPIRED", async () => {
        ...
        await expect(LocationService.respondToLocationRequest(t, lr.id, {
            latitude: 1,
            longitude: 1,
    ...
    it("getLocationRequestResult reads once", async () => {
        ...
        await redis.set(`hr:location:request:${lr.id}`, JSON.stringify({ latitude: 5, longitude: 6 }));
    ...
    it("rejects unauthorized result read", async () => {
        ...
        await expect(LocationService.getLocationRequestResult(t, lr.id)).rejects.toThrow("Not allowed");
    });
});
//# sourceMappingURL=location.service.integration.test.js.map