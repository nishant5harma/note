...
describe("Permission Service (Integration)", () => {
    describe("createPermission", () => {
        ...
        it("should throw error if duplicate key is used", async () => {
            ...
            await expect(PermissionService.createPermission({ key: "test" })).rejects.toThrow();
        });
    });
    describe("updatePermission", () => {
        ...
        it("should throw a Prisma error when updating to a key that already exists", async () => {
            ...
            await expect(PermissionService.updatePermission(b.id, { key: "perm:a" })).rejects.toThrow(); // Prisma P2002 Unique constraint error
        });
    });
    describe("deletePermission", () => {
        ...
        it("should throw error if permission is assigned to a role", async () => {
            ...
            await expect(PermissionService.deletePermission(perm.id)).rejects.toThrow("Permission assigned to roles. Revoke before deleting.");
        });
    });
});
//# sourceMappingURL=permission.service.integration.test.js.map