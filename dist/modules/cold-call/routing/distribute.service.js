...
export async function distributeColdCallBatchService(batchId, opts = {}) {
    ...
    const distribution = {};
    const previewRows = [];
    const weights = (batch.teamConfig && batch.teamConfig.weights) ?? undefined;
    ...
    for (let i = 0; i < entries.length; i++) {
        ...
        const isPreviewRow = typeof previewLimit === "number" &&
