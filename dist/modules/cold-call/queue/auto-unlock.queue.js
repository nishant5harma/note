...
async function scheduleAutoUnlock() {
    await coldCallAutoUnlockQueue.add("auto-unlock-task", // job name
    {}, // no payload needed
    {
        repeat: {
...
scheduleAutoUnlock().catch((err) => console.error("Failed to schedule coldcall auto-unlock job:", err));
//# sourceMappingURL=auto-unlock.queue.js.map