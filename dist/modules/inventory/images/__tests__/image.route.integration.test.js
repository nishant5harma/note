...
await jest.unstable_mockModule("@/modules/socket/util-socket/push.sender.js", () => ({
    __esModule: true,
...
describe("Inventory Image Routes (integration)", () => {
    ...
    it("blocks unauthenticated upload", async () => {
        ...
        const res = await request(app).post(`/api/inventory/listings/${listing.id}/images`);
        expect(res.status).toBe(401);
    });
});
//# sourceMappingURL=image.route.integration.test.js.map