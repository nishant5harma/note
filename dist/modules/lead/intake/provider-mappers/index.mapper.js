...
export function applyProviderMapper(provider, raw) {
    const p = (provider ?? "").toLowerCase();
    if (p.includes("facebook"))
        return mapFacebookLead(raw);
    if (p.includes("google_ads") ||
