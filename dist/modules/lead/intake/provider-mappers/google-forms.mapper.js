import { safeStr, findByKeyCaseInsensitive, pickFromFieldArray, } from "./helpers.js";
/**
 ...
 */
export function mapGoogleForms(raw) {
    try {
        ...
        const answersArray = formResponse?.answers ??
        ...
        if (Array.isArray(answersArray)) {
            ...
            email = safeStr(findByKeyCaseInsensitive(formResponse, [
                "email",
                "emailAddress",
                "email_address",
            ]));
            phone = safeStr(findByKeyCaseInsensitive(formResponse, [
                "phone",
                "mobile",
                "phoneNumber",
                "phone_number",
            ]));
            name = safeStr(findByKeyCaseInsensitive(formResponse, [
                "name",
                "fullName",
                "full_name",
            ]));
        ...
        const externalId = safeStr(formResponse?.responseId ??
            formResponse?.id ??
...
//# sourceMappingURL=google-forms.mapper.js.map