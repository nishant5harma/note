...
const mockCreateRefreshTokenForUser = jest.fn(async () => "mock-refresh-token");
const mockConsumeRefreshToken = jest.fn();
const mockRevokeRefreshToken = jest.fn(async () => { });
...
describe("Auth Service (Integration)", () => {
    ...
    describe("login", () => {
        ...
        it("should throw UnauthorizedError for wrong password", async () => {
            ...
            await expect(AuthService.login(user.email, "wrong-pass", mockRes)).rejects.toThrow("invalid credentials");
        });
    });
    describe("refresh", () => {
        ...
        it("should throw if token is missing or invalid", async () => {
            ...
            await expect(AuthService.refresh(undefined, mockRes)).rejects.toThrow("refresh token missing");
            await expect(AuthService.refresh("invalid", mockRes)).rejects.toThrow("invalid or expired refresh token");
        });
    });
    describe("logout", () => {
...
//# sourceMappingURL=auth.service.integration.test.js.map