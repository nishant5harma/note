...
import {
  ...
  locationRequestRespondSchema,
} from "./validator/location.validator.js";
 ...
 */
async function createLocationRequestHandler(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
  try {
    ...
    const reqRow = await LocationService.createLocationRequest(
      req.user,
      data.targetUserId,
 ...
 */
async function respondLocationRequestHandler(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
 ...
 */
async function getLocationRequestResultHandler(
  req: AuthRequest,
  res: Response,
  next: NextFunction
) {
