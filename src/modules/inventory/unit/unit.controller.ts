...
import {
  createUnitSchema,
  updateUnitSchema,
} from "./validator/unit.validator.js";
    ...
    const filter: UnitFilter = {
      ...
      projectId:
        typeof req.query.projectId === "string"
          ...
          : undefined,
      towerId:
        typeof req.query.towerId === "string" ? req.query.towerId : undefined,
      status:
      ...
      sort:
        typeof req.query.sort === "string"
          ? (req.query.sort as UnitFilter["sort"])
          : undefined,
    };
...
export async function sellUnitHandler(
  req: Request,
  res: Response,
  next: NextFunction
) {
