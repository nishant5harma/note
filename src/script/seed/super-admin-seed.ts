...
async function main() {
  ...
  const basePermissions = [
    ...
    { key: "team.assignLead", description: "Assign team lead", module: "Team" },
    {
      key: "team.request",
      description:
        "Create team membership requests (assign/remove/join/transfer)",
      module: "Team",
    },
    {
      key: "team.approve",
    ...
    // Cold Call
    { key: "coldcall.read", description: "Read cold call data/reports", module: "ColdCall" },
    { key: "coldcall.upload", description: "Upload cold call batches (xlsx/csv)", module: "ColdCall" },
    { key: "coldcall.distribute", description: "Distribute cold call batches to teams", module: "ColdCall" },
    { key: "coldcall.call", description: "Agent calling workflow (pull/attempt/complete)", module: "ColdCall" },
    { key: "coldcall.assign", description: "Reassign cold call entries", module: "ColdCall" },
    { key: "coldcall.admin", description: "Cold call admin actions (quota)", module: "ColdCall" },
    ...
    },
    {
      ...
      description:
        "Manage advanced inventory states (BLOCK, UNDER_OFFER, SOLD, BOOKING, etc.)",
      module: "Inventory",
    },
  ];
  ...
  const existingPermissionIds = new Set(
    existingRolePerms.map((r) => r.permissionId)
  );
  ...
  if (linksToCreate.length > 0) {
    ...
    console.log(
      `✅ Linked ${linksToCreate.length} permissions to Super Admin.`
    );
  } else {
